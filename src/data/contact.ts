...
export const contactInfo = {
    ...
    links: [
        { id: 1, icon: 'uil uil-twitter', url: 'https://twitter.com/parlicentre' },
        { id: 2, icon: 'uil uil-facebook-f', url: 'https://www.facebook.com/parlicentre/' },
        { id: 3, icon: 'uil uil-linkedin', url: 'https://www.linkedin.com/company/international-centre-for-parliamentary-studies' },
      ]
}